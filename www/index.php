...
<body>
   ...
   <div class="container mx-auto my-6 p-6 bg-gray-100">
      ...
      <p>Notre nom, WeND(Y), signifie "We’re not dead (yet)", reflétant notre engagement à célébrer la vie et à offrir
         ...
         succès.</p>
      <p>Merci d'avoir choisi WeND(Y) pour votre prochain événement. Nous sommes impatients de travailler avec vous pour
