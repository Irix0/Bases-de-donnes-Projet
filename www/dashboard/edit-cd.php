...
<body>
   ...
   <div class="2xl:mx-80 xl:mx-60 lg:mx-20 md:mx-10 mt-2 px-6 py-6 lg:px-8">
      ...
      <div class="flex content-center items-center">
            <div class="basis-1/12">
               <button onclick="document.location.replace('/dashboard/cd.php')" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm px-3 py-5 inline-flex items-center">
      ...
      <button data-modal-target="add-song-modal" data-modal-toggle="add-song-modal" class="mt-6 block bg-blue-50 rounded text-sm font-medium text-blue-500 hover:bg-blue-100 hover:text-blue-600 px-5 py-2.5 text-center" type="button">
         Ajouter une chanson
      </button>
                  ...
                  for ($i = 1; $i <= $page_nb; $i++) {
                     if ($i == $page) {
                        ...
                        <a
                           ...
                           class="absolute -m-px h-px w-px overflow-hidden border-0 p-0 [clip:rect(0,0,0,0)]" >(current) </span></a></li>';
                     } else {
                        echo '<li>
                        ...
                        href = "edit-cd.php?page=' . $i . '&cd_number=' . $cdNumber . '">' . $i . ' </a></li>';
                     }
                  }
                  ?>
               </ul>
   ...
   <!-- Add modal -->
   <div id="add-song-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-md max-h-full">
         <!-- Modal content -->
         <div class="relative bg-white rounded-lg shadow">
            <button class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="add-song-modal">
            ...
            <div class="px-6 py-6 lg:px-8">
               ...
               <form method="post" class="space-y-6" action="#">
                  <div>
                     ...
                     <input type="text" name="street" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="The Queen is Dead" required>
                  </div>
                  <div class="flex space-x-8">
                     <div>
                        <label for="artist" class="block mb-2 text-sm font-medium text-gray-900">Artiste*</label>
                        <input type="text" name="artist" id="artist" placeholder="The Smiths" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                     </div>
                     <div>
                        <label for="duration" class="block mb-2 text-sm font-medium text-gray-900">Durée*</label>
                        <input type="text" name="duration" id="duration" placeholder="00:00:00" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required maxlength="8">
                     </div>
                  </div>
                  <div>
                     <label for="genre" class="block mb-2 text-sm font-medium text-gray-900">Genre*</label>
                     <input type="text" name="genre" id="genre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Pop" required>
                  </div>
                  <div>
                     <label for="track_number" class="block mb-2 text-sm font-medium text-gray-900">Track Number</label>
                     <input type="number" name="track_number" id="track_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="20">
                  </div>
