   ...
   <div class="2xl:mx-80 xl:mx-60 lg:mx-20 md:mx-10 mt-2 px-6 py-6 lg:px-8">
      ...
      <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 text-blue-600">
               ...
               <form method="post" action="#">
                  ...
                  <div class="flex space-x-8">
                     <div class="basis-1/2">
                        ...
                        <input type="text" name="first_name" placeholder="Prénom" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                     <div class="basis-1/2">
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">Nom</label>
                        <input type="text" name="last_name" placeholder="Nom" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
                  <div class="flex space-x-8">
                     <div class="basis-1/2">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Adresse e-mail</label>
                        <input type="text" name="email" placeholder="Adresse e-mail" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                     <div class="basis-1/2">
                        <label for="phone_nb" class="block mb-2 text-sm font-medium text-gray-900">Numéro de
                           téléphone</label>
                        <input type="text" name="phone_nb" placeholder="Numéro de téléphone" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
                  <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Chercher</button>
               </form>
            </div>
         </div>
               ...
               <form method="post" action="#">
                  ...
                  <div class="flex space-x-8">
                     <div class="basis-1/2">
                        ...
                        <input type="text" name="city" placeholder="Ville" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                     <div class="basis-1/2">
                        <label for="zip" class="block mb-2 text-sm font-medium text-gray-900">Code postal</label>
                        <input type="text" name="zip" placeholder="Code postal" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
                  ...
                  <input type="text" name="comment" placeholder="Commentaire" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                  <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Chercher</button>
               </form>
            </div>
         </div>
         <h2 id="accordion-color-heading-4"> <!-- EVENTS -->
            <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 focus:ring-4 focus:ring-blue-200 hover:bg-blue-100" data-accordion-target="#accordion-color-body-4" aria-expanded="false" aria-controls="accordion-color-body-4">
               ...
               <form method="post" action="#">
                  ...
                  <div class="flex space-x-8">
                     <div class="basis-4/12">
                        ...
                        <input type="text" name="client" placeholder="Nom du Client" class="bg-gray-50 border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                     </div>
                     <div class="basis-4/12">
                        <label for="manager" class="block mb-2 text-sm font-medium text-gray-900">Manager</label>
                        <input type="text" name="manager" placeholder="Nom du Manager" class="bg-gray-50 border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                     </div>
                     <div class="basis-4/12">
                  ...
                  <div class="flex space-x-8">
                     ...
                     <div class="basis-4/12">
                        ...
                        <input type="text" name="type" placeholder="Type" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
                  <label for="desc" class="block mb-2 text-sm font-medium text-gray-900">Description</label>
                  <input type="text" name="desc" placeholder="Description" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                  <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Chercher</button>
               </form>
            </div>
         </div>
               ...
               <form method="post" action="#">
                  ...
                  <div class="flex space-x-8">
                     <div class="basis-1/2">
                        ...
                        <input type="text" name="artist" placeholder="Artiste" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                     <div class="basis-1/2">
                        <label for="duration" class="block mb-2 text-sm font-medium text-gray-900">Durée</label>
                        <input type="time" name="duration" placeholder="00:00:00" step="2" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
         ...
         <h2 id="accordion-color-heading-6"> <!-- CDs -->
            <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 focus:ring-4 focus:ring-blue-200 hover:bg-blue-100" data-accordion-target="#accordion-color-body-6" aria-expanded="false" aria-controls="accordion-color-body-6">
               <span>CDs</span>
               <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
               </svg>
               ...
               <form method="post" action="#">
                  ...
                  <div class="flex space-x-8">
                     <div class="basis-1/2">
                        ...
                        <input type="text" name="producer" placeholder="Producteur" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                     <div class="basis-1/2">
                        <label for="year" class="block mb-2 text-sm font-medium text-gray-900">Année de sortie</label>
                        <input type="number" name="year" placeholder="1999" class="bg-gray-50 w-full px-4 py-2 mb-4 border rounded-lg">
                     </div>
                  </div>
