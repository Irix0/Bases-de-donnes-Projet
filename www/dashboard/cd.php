                  ...
                  <td class='px-6 py-4'>
                     ...
                     <a href='edit-cd.php?cd_number=" . $row['CD_NUMBER'] . "'>
                        <button data-modal-target='add-cd-modal' data-modal-toggle='add-cd-modal'
                           class='faa-parent animated-hover text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-4 text-center mr-2 mb-2'
                           type='button'>
